...
model ReadFromCalBay "Block that read data from Calbay using Python function"
...
initial equation
   ...
   // be overwritten.
   yR = zeros(nDblRea);
   assert(nStrWri==nDblRea, "Parameter nStrWri'" + String( nStrWri) + "should match parameter nDblRea " + String( nDblRea));
equation
