...
model WriteToCalBay "Block that write data to Calbay using a Python function"
...
public
  ...
  ///////////////////////////////////////////////////////////////////////
  // FIXME: Added the following to enable communications.
  parameter Integer nStrWri(min=1)
    "Number of strings values to write to Python";
...
initial equation
   ...
   // be overwritten.
   yR = zeros(nDblRea);
   assert(nStrWri==nDblWri, "Parameter nStrWri" + String( nStrWri) + "should match parameter nDblWri " + String( nDblWri));
equation
   for i in 1:nDblWri loop
